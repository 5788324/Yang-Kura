...
assert.ok(versionMatch, `invalid application version: ${pkg.version}`);
const [majorVersion, minorVersion] = versionMatch.slice(1, 3).map(Number);
assert.ok(majorVersion >= 1 || (majorVersion === 0 && minorVersion >= 170), `version predates U41-B: ${pkg.version}`);
