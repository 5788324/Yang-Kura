...
try {
  ...
  await cdp.evaluate('(() => { const root=document.querySelector("#root > div"); root.classList.remove("theme-dark","theme-acrylic-mist","theme-ocean-drops"); root.classList.add("theme-ocean-drops"); root.dataset.u30Theme="ocean-drops"; return true; })()');
  await waitFor(cdp, 'document.documentElement.dataset.ykTheme === "mist-ivory"', 'K2-R5 light-first theme ready');
