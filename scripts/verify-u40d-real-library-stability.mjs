...
const checks = [
  ...
  ['src/services/automationProfileCleanupService.ts', ['u29-lrc', 'YANG_KURA_E2E_MODE', 'removedQueueTracks']],
  ['src/services/libraryIndexNormalizationService.ts', ['RJ_PATTERN', 'MAX_REASONABLE_WORK_TRACKS', 'splitCollection', "tracks.length === 0"]],
