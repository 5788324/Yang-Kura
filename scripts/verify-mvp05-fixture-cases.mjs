...
for (const file of ['src/services/fixtureLibrarySample.ts','src/services/fixtureLibraryScanner.ts','src/services/fixtureScannerReportService.ts','docs/FIXTURE_CASES_MVP05.md','scripts/verify-mvp05-fixture-cases.mjs']) requireFile(file);
...
for (const token of ['IMAGE_EXTENSIONS','trackKindFromExtension','image','video','audio']) if(!scanner.includes(token)) failures.push(`fixture scanner missing token: ${token}`);
...
console.log('[Yang-Kura] MVP-05 fixture cases static verification passed.');
