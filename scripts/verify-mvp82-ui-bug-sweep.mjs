...
assert(['0.120.0-mvp82', '0.121.0-mvp83', '0.122.0-mvp84', '0.123.0-mvp85'].includes(packageJson.version), `package.json version must be 0.120.0-mvp82 or compatible MVP-83, got ${packageJson.version}`);
