...
assert(['0.128.0-mvp90', '0.129.0-mvp91', '0.130.0-mvp92', '0.131.0-mvp93'].includes(pkg.version), `package.json version must be 0.128.0-mvp90 or compatible MVP-91, got ${pkg.version}`);
assert(['0.128.0-mvp90', '0.129.0-mvp91', '0.130.0-mvp92', '0.131.0-mvp93'].includes(lock.version), `package-lock version must be 0.128.0-mvp90 or compatible MVP-91, got ${lock.version}`);
assert(['0.128.0-mvp90', '0.129.0-mvp91', '0.130.0-mvp92', '0.131.0-mvp93'].includes(lock.packages?.['']?.version), 'package-lock root package version must be 0.128.0-mvp90 or compatible MVP-91');
