...
for (const marker of ['const DAILY_NAV_ITEMS', 'const MAINTENANCE_NAV_ITEMS', 'SidebarNavSection', '媒体与导入', '设置与维护']) if (!sidebar.includes(marker)) failures.push('sidebar grouping contract missing: '+marker);
