...
settings = replaceOnceRegex(
  settings,
  /(\s*\{\/\* MVP-07 Scanner Contract UI Flow \*\/}\r?\n\s*)<div className="bg-blue-500\/5 border border-blue-500\/15 p-5 rounded-2xl space-y-4">/,
  '$1<div hidden aria-hidden="true" className="bg-blue-500/5 border border-blue-500/15 p-5 rounded-2xl space-y-4">',
  'scanner contract block',
);
