...
assert(['0.121.0-mvp83', '0.122.0-mvp84', '0.123.0-mvp85'].includes(pkg.version), `package.json version must be 0.121.0-mvp83 or compatible MVP-84, got ${pkg.version}`);
assert(['0.121.0-mvp83', '0.122.0-mvp84', '0.123.0-mvp85'].includes(lock.version), `package-lock version must be 0.121.0-mvp83 or compatible MVP-84, got ${lock.version}`);
assert(['0.121.0-mvp83', '0.122.0-mvp84', '0.123.0-mvp85'].includes(lock.packages?.['']?.version), 'package-lock root package version must be 0.121.0-mvp83 or compatible MVP-84');
