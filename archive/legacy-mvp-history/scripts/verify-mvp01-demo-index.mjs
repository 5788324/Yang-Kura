...
if (!packageJson.includes('0.40.0-mvp01') && !packageJson.includes('0.41.0-mvp02') && !packageJson.includes('0.42.0-mvp03') && !packageJson.includes('0.43.0-mvp04') && !packageJson.includes('0.44.0-mvp05') && !packageJson.includes('0.45.0-mvp06') && !packageJson.includes('0.46.0-mvp07') && !packageJson.includes('0.47.0-mvp08') && !packageJson.includes('0.47.1-mvp08.1') && !packageJson.includes('0.48.0-mvp09') && !packageJson.includes('0.49.0-mvp10') && !packageJson.includes('0.50.0-mvp11') && !packageJson.includes('0.51.0-mvp12') && !packageJson.includes('0.52.0-mvp13') && !packageJson.includes('0.53.0-mvp14') && !packageJson.includes('0.54.0-mvp15') && !packageJson.includes('0.55.0-mvp16') && !packageJson.includes('0.56.0-mvp17') && !packageJson.includes('0.57.0-mvp18') && !packageJson.includes('0.58.0-mvp19') && !packageJson.includes('0.60.0-mvp22') && !packageJson.includes('0.61.0-mvp23') && !packageJson.includes('0.62.0-mvp24') && !packageJson.includes('0.63.0-mvp25') && !packageJson.includes('0.64.0-mvp26') && !packageJson.includes('0.67.0-mvp29') && !packageJson.includes('0.67.1-mvp29.1', '0.68.0-mvp30', '0.69.0-mvp31')) failures.push('package.json version not updated to MVP-01 or later');
