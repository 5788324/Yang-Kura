...
版本：`0.127.0-mvp89`。已新增 `importConflictDetectionPreviewService` 与 `mvp89-import-conflict-detection-preview` / diagnostics 区块。下一轮建议 MVP-90：目标路径规划预览。仍禁止真实文件操作和真实 hash 计算。
